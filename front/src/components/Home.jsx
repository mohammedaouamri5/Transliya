...
const Home = () => {
  ...
  return (
    <>
          ...
          <div className="w-[85%] h-[70%] flex items-center md:justify-end md:text-end text-center justify-center">
            <div className="md:w-[60%] lg:w-[50%] w-full">
              <div className="flex-col">
                ...
                <br />
                <Link to={'/booking'} className="px-8 py-3 text-background text-lg hover:bg-light duration-200 rounded bg-white">
                  احجز الآن
                </Link>
              </div>
            </div>
      ...
      <section className="h-[100vh] w-full bg-background relative text-light p-10">
        <div className="w-[90%] md:w-[80%] flex flex-col justify-center items-center m-auto gap-6">
          ...
          <div className="flex flex-row w-full items-center justify-between">
            <div className="h-[65vh] w-[30%] bg-light text-background rounded-lg flex items-center flex-col justify-between">
            <div className="w-full h-full m-auto p-5 flex flex-col justify-around items-center text-center">
            <PiListChecksBold className="text-5xl h-[30%]" />
                <h1 className="text-xl font-bold h-[20%]">اطلب العرض الذي يناسبك</h1>
                <p className="text-accent font-light h-[50%]">
                  {" "}
            ...
            <div className="h-[65vh] w-[30%] bg-light text-background rounded-lg">
              <div className="w-full h-full m-auto p-5 flex flex-col justify-around items-center text-center">
                <PiCursorClickFill className="text-5xl h-[30%]" />
                <h1 className="text-xl font-bold h-[20%]">حدد الطلب</h1>
                <p className="text-accent font-light h-[50%]">
                  {" "}
            ...
            <div className="h-[65vh] w-[30%] bg-light text-background rounded-lg">
            <div className="w-full h-full m-auto p-5 flex flex-col justify-around items-center text-center">
            <MdLocalShipping className="text-5xl h-[30%]" />
                <h1 className="text-xl font-bold h-[20%]">استرخ واستمتع</h1>
                <p className="text-accent font-light h-[50%]">
                  {" "}
      ...
      <div className="relative h-fit w-full bg-light text-background flex flex-col items-center p-4 gap-6">
        <div className="w-[80%] lg:w-[85%] h-fit m-auto lg:flex-row text-center flex justify-between lg:text-end flex-col p-5 md:gap-0 gap-6 ">
          <h1 className="text-4xl lg:hidden  w-full leading-snug px-2 font-bold">
          ...
          <h1 className="text-4xl w-[47%] leading-snug px-2 font-bold hidden lg:block">
            نقل وكراء بلا حدود، لأننا في
            <span className="text-accent"> ترانزليا </span>
            ملتزمون بتقديم خدمات لا مثيل لها في مجال النقل والكراء.
          </h1>
