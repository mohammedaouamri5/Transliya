    ...
    <>
      <section className="bg-white">
        <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
          ...
          خدمة ممتازة في نقل مواد البناء! أوصي بشدة بشركة ترانسليا لأي شخص يحتاج إلى نقل مواد البناء. كانت العملية سلسة وفعالة، وكان السائقون محترفين للغاية. لقد وفر لي الكثير من الوقت والجهد، وسأستخدمهم بالتأكيد مرة أخرى .
