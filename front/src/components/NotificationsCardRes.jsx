    ...
    <>
      <div className="p-3 w-full bg-background rounded-lg mb-5 flex text-end items-center justify-between text-light ">
        ...
        <div className="flex items-center">
          <h1>
            تم قبول طلبك للكراء الرجاء التواصل مع صاحب الشاحنة لاتمام العملية{" "}
          </h1>{" "}
      ...
      >
        <Box sx={style} className="bg-background">
          ...
          <div className="w-[80%]">
            <h1 className="text-4xl text-center text-light font-bold my-7">أترك تقييما</h1>
...
export default NotificationsCardRes;
